                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="cart-image">
                                        <a class="entry-thumbnail" href="detail.php">
                                            <img src="assets/images/products/p1.jpg" style="width:80px; height:80px;" alt="">
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="cart-image">
                                        <a class="entry-thumbnail" href="detail.php">
                                            <img src="assets/images/products/p2.jpg" style="width:80px; height:80px;" alt="">
                                        </a>
                                    </td>
                                    <td class="cart-product-name-info">
                                        <h4 class='cart-product-description'><a href="detail.php">Floral Print Buttoned</a></h4>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="cart-checkout-btn pull-right">
                                                    <a href="checkout.php" type="submit" class="btn btn-primary">PROCCED TO CHEKOUT</a>
                                                </div>
                                            </td>
                                        </tr>
                                </tbody><!-- /tbody -->
