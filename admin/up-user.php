                                        ...
                                        <div class="card-body">
                                            <?php
                                                if (isset($_POST['save_user_info'])) {
                                                    ...
                                                    $sqlInput = mysqli_query($DB_CONNECT,"INSERT INTO `users`(`username`, `firstname`, `lastname`, `email`, `password`, `phone`, `address`, `city`, `state`, `zip`, `position`) VALUES ('$inputUsername','$inputFirstName','$inputLastName','$inputEmail','$inputPassword','$inputPhone','$inputAddress','$inputCity','$inputState','$inputZip','$inputPosition')");

                                                    if ($inputPassword != $inputRePassword) {
                                                        echo "Re-Typed Password doesn't Macth!!!".mysql_error();
                                                    }
                                                    else {
                                                        if ($sqlInput) {
                                                            ?>
                                                            ...
                                                            echo "Failed to add new user".mysql_error();
                                                        }
                                                    }
                                        ...
                                        <div class="card-body">
                                            <?php
                                                if (isset($_POST['submit_company_details'])) {
                                                    ...
                                                    $location = 'img/logo/'.basename($_FILES['logo']['name']);
                                                    ...
                                                    if(move_uploaded_file($_FILES['logo']['tmp_name'], $location)){
                                                        ...
                                                        echo "Failed to upload image!!".mysql_error();
                                                    }
                                                        ...
                                                        <div class="text-center">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                    <div class="fileupload-new thumbnail" style="width: 60%; height: 120px;"><img src="img/logo/demoUpload.jpg" alt="" /></div>
